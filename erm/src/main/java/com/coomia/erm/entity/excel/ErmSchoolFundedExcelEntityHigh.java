 ...
 */
@ExcelVoConfig
public class ErmSchoolFundedExcelEntityHigh extends BaseExcelVo implements Serializable {
	...
	@InputDicConfig(dicCode = "XXJB") // Excel导入的配置
	@OutputDicConfig(dicCode = "XXJB") // Excel导出的配置
	@DicValidateConfig(dicCode = "XXJB") // 如果要导出下拉框就加这个
	@Lang(value = "资助档次") // Excel导出的配置
