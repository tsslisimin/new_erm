        ...
        <v-table v-if="listData.length" :nowrap="true" :items="listData" :header="headData">
          ...
          <template slot="t-body" slot-scope="props">
            <tr>
              ...
              <td class="center">&nbsp;&nbsp;&nbsp;<Button type="error" @click="del(props.data.id)">删除</Button>
              </td>
            </tr>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      del(id) {
        io.post(api.fundProcess.deleteApply + '/' + id, (res) => {
          console.log(res)
          if (res.code === 200) {
            this.getList()
          } else {
