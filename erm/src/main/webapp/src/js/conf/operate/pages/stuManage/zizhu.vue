  ...
  <div class="wrapper">
    ...
    <div class="con">
      <Card :padding="10">
        ...
        <v-table v-if="listData.length" :items="listData" :header="[]">
          <template slot="t-header">
            ...
            <th class="center"><p sort-key="stuno"><span>学号</span><span class="sort"><i class="iconfont up">&#xe6f4;</i><i
              class="iconfont down">&#xe608;</i></span></p></th>
            <th class="center"><p sort-key="school"><span>学校名称</span><span class="sort"><i
              class="iconfont up">&#xe6f4;</i><i
              class="iconfont down">&#xe608;</i></span></p></th>
            <th class="center"><p sort-key="grade"><span>年级</span><span class="sort"><i class="iconfont up">&#xe6f4;</i><i
              class="iconfont down">&#xe608;</i></span></p></th>
            <th class="center"><p sort-key="clazz"><span>班级</span><span class="sort"><i class="iconfont up">&#xe6f4;</i><i
              class="iconfont down">&#xe608;</i></span></p></th>
            <th class="center"><p sort-key="zone"><span>学段</span><span class="sort"><i
              class="iconfont up">&#xe6f4;</i><i class="iconfont down">&#xe608;</i></span></p></th>
            <th class="center"><p sort-key="diffLevel"><span>困难等级</span><span class="sort"><i class="iconfont up">&#xe6f4;</i><i
              class="iconfont down">&#xe608;</i></span></p></th>
            <th class="center"><p sort-key="score"><span>智能得分</span><span class="sort"><i
              class="iconfont up">&#xe6f4;</i><i class="iconfont down">&#xe608;</i></span></p></th>
          ...
          <template slot="t-body" slot-scope="props">
            <tr>
              ...
              <td class="center">
                <Button type="primary" @click="verifyAgree(props.data.id)">通过</Button>&nbsp;&nbsp;&nbsp;<Button
                type="error" @click="verifyReject(props.data.id)">调整
              </Button>
              </td>
            </tr>
          </template>
        ...
        <div class="edit">
          <Modal v-model="agreeModal" title="通过" :ok-text="'通过'" @on-ok="agreeInfo" @on-cancel="agreeModal = false">
            <div class="edit-con">
              <Form ref="agreeEdit" :model="agreeEdit" :label-width="80" style="padding-top: 15px;">
                <FormItem label="指定项目" style="margin-bottom: 20px;">
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        io.get(api.student.list, _data, (res) => {
          let data = res.data
          console.log(data)
